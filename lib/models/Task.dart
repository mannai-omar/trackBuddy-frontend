...
class Tasks {
  ...
  factory Tasks.fromJson(Map<String, dynamic> json) => Tasks(
        ...
        miniTasks: List<MiniTask>.from(
            json["miniTasks"].map((x) => MiniTask.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "creator": creator,
        "users":
            users != null ? List<dynamic>.from(users!.map((x) => x)) : null,
        "miniTasks": miniTasks != null
            ? List<dynamic>.from(miniTasks!.map((x) => x))
            : null,
